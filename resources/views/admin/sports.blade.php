...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex flex-col flex-1 w-full">
            <header class="flex items-center justify-between h-16 bg-white border-b px-6">
                <div>
                    <h2 class="text-lg font-medium">Sports</h2>
                </div>
                <div>
            ...
            <main class="flex-1 p-6 bg-gray-100 overflow-y-auto">
                <div class="mb-6 flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2" data-url="{{route('adminsports.filter')}}" id="types-filter">
                        <select
                            class="px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-300"
                            id="typeSelect">
                    ...
                    <div class="flex items-center space-x-2" data-url="{{route('adminsports.filter')}}" id="events-filter">
                        <select
                            class="px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-300"
                            id="filterSelect">
                            <option value="all">All Events</option>
                    ...
                    <table class="min-w-full border-collapse">
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Sport Type</th>
                                ...
                                <th class="px-6 py-3 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Team A</th>
                                <th class="px-6 py-3 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Team B</th>
                        ...
                        <tbody id="eventTableBody">
                            @include('admin.partials.sportslist')
                        </tbody>
                    </table>
                </div>
            </main>
    ...
    <script src="{{asset('js/adminsports.js')}}"></script>
</body>
